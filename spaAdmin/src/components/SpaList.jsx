                                            ...
                                            <td className="px-2 sm:px-4 lg:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm">
                                                <div className="flex flex-col sm:flex-row gap-1 sm:gap-2">
                                                    <button
                                                        ...
                                                        className="text-blue-600 hover:text-blue-900 disabled:text-gray-400 text-left"
                                                    >
                                                        Edit
                                                    </button>
                                                    <button
                                                        ...
                                                        disabled={actionInProgress === spa._id}
                                                        className="text-red-600 hover:text-red-900 disabled:text-gray-400 text-left"
                                                    >
                                                        {actionInProgress === spa._id ? '...' : 'Delete'}
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
